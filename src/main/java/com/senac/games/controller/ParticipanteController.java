...
public class ParticipanteController {
    ...
    @GetMapping("/listar")
    @Operation(summary = "Listar participantes",description = "Endpont para listar todos os participantes")
    ...
    public ResponseEntity<Participante>listarPorParticipanteId(@PathVariable("participante_id")Integer participanteId){
    ...
    @PostMapping("/criar")
    @Operation(summary = "Criar novo participante",description = "Endpoint para criar um novo registro no participante")
